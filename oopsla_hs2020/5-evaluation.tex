...
\item The difference between 1 thread and 4 threads can be quite significant, and typically \Make and \Rattle do equally well with parallelism. The implicit parallelism in \Rattle is an important feature which works as designed.  \Rattle doesn't always perform as well when building with 32 threads, displaying thread related overhead in that could be optimised away -- we leave that optimisation as future work.
