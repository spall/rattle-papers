...
\item Every \Make project has a minor variation on how dependencies are managed. Most make use of \texttt{gcc} to generate dependency information%% , which then has to be provided to \Make
