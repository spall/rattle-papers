...
% SS In this example Rattle doesn't need to do anything because the new main will just overwrite the old incorrect main.  So, need a better example.
%    But this is also maybe a place where we can refine Rattle's behavior in a way that we currently don't.
