...
Importantly \texttt{cmd} waits until the command has finished -- be that skipped, downloaded from the cloud or actually run -- before returning.

All our predictions only look at the very last run. Simple, and seems to be sufficient.
