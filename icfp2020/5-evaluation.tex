...
% SS TODO fill in because I still don't totally understand why they did this.

What are these intermediate files for?
As an example of this, take the \emph{v8\_snapshot} target.
A file \Make rebuilt when nothing had changed was \emph{out/Release/obj.target/v8\_snapshot/geni/snapshot.cc}.  This file depends on \emph{598e7eaef0d59ad60e6e924931a138bd5d9d8789.intermediate}, and
  \emph{598e7eaef0d59ad60e6e924931a138bd5d9d8789.intermediate} depends on \emph{mksnapshot} and \emph{FORCE\_DO\_CMD}.

  \emph{598e7eaef0d59ad60e6e924931a138bd5d9d8789.intermediate} is touched; and then
  \emph{cmd\_598e7eaef0d59ad60e6e924931a138bd5d9d8789.intermediate := touch 598e7eaef0d59ad60e6e924931a138bd5d9d8789.intermediate'} is written to \emph{598e7eaef0d59ad60e6e924931a138bd5d9d8789.intermediate.d}.

  % This is then almost immediately overwritten by \emph{cmd\_598e7eaef0d59ad60e6e924931a138bd5d9d8789.intermediate := LD\_LIBRARY\_PATH=/home/spall/rattle-papers/tools/output/node3/out/Release/lib.host:/home/spall/rattle-papers/tools/output/node3/out/Release/lib.target:$$LD\_LIBRARY_PATH; export LD\_LIBRARY\_PATH; cd ../tools/v8\_gypfiles; mkdir -p /home/spall/rattle-papers/tools/output/node3/out/Release/obj.target/v8\_snapshot/geni; "/home/spall/rattle-papers/tools/output/node3/out/Release/mksnapshot" --turbo\_instruction_scheduling "--target\_os=linux" "--target\_arch=x64" --startup\_src "/home/spall/rattle-papers/tools/output/node3/out/Release/obj.target/v8_snapshot/geni/snapshot.cc" --embedded\_variant Default --embedded\_src "/home/spall/rattle-papers/tools/output/node3/out/Release/obj.target/v8\_snapshot/geni/embedded.S" --no-native-code-counters}
